...
plt.plot(time11,temp11)
plt.xlabel('Time [s]')
plt.ylabel('Temperature [°C]')
plt.title('Temperature change: Case with isolation')
plt.show() 
plt.plot(time22,temp22)
plt.xlabel('Time [s]')
plt.ylabel('Temperature [°C]')
plt.title('Temperature change: Case with no isolation')
plt.show()
...
plt.title('Heat transfer change: Case with isolation')
plt.show() 
plt.plot(time22,q22)
plt.xlabel('Time [s]')
plt.ylabel('Heat transfer [W]')
plt.title('Heat transfer change: Case with no isolation')
plt.show()
